...
##  {#link-to-slides .center data-menu-title="Link to slides" background-image="images/horst_quarto_penguins_thankyou.png" aria-label="Two penguins standing on an iceberg at dawn, viewed from behind, with their arms around each others' shoulders. A Quarto logo moon is near the horizon."}

[[mine-quarto-pub/hello-quarto-bioc](https://mine-quarto-pub/hello-quarto-bioc)]{.custom-url-top-dark}

::: notes
But I hope you'll continue to listen with one ear and take in the beautiful illustrations by Allison Horst.
And if you just want to enjoy the talk, feel free to go to this link.
...
##  {#demo-share .centered data-menu-title="Demo: Share" background-color="#FFFFFF"}
