...
## Acknowledgements {background-color="#0F1620" .center .centered}
...
::: notes
I'm going to introduce Quarto in four acts -- Share, Collaborate, Teach, and Reimagine. Each with a story and a demo. So, let's get started.
:::
...
[[mine.quarto.pub/hello-quarto-bioc](https://mine.quarto.pub/hello-quarto)]{.custom-url-middle-dark}
...
The slides for the talk are at the link above. And if you go there and proceed to the next slide you'll find many useful resources, including the source code for the site we built in the demos.
